...
//! under `tests/release-e2e/cases/20[2-9]_implicit_*.rx`.
//!
...
//!
//! Every fixture lives in `tests/fixtures/ruxen/<test-fn-name>.rx`
//! and is loaded at runtime via the `rx(name)` helper below.
...
/// Lex + parse + typecheck a Ruxen source string and return every
...
fn derive_copy_clone_on_pod_struct_typechecks_cleanly() {
    let source = rx("derive_copy_clone_on_pod_struct_typechecks_cleanly");
...
fn copy_with_non_copy_field_reports_e0601() {
    let source = rx("copy_with_non_copy_field_reports_e0601");
...
fn copy_without_clone_reports_e0602() {
    let source = rx("copy_without_clone_reports_e0602");
...
fn copy_on_class_reports_e0603() {
    let source = rx("copy_on_class_reports_e0603");
...
fn eq_without_partial_eq_reports_e0604() {
    let source = rx("eq_without_partial_eq_reports_e0604");
...
fn default_on_enum_without_default_variant_reports_e0605() {
    let source = rx("default_on_enum_without_default_variant_reports_e0605");
...
fn ord_without_eq_and_partial_ord_reports_e0606() {
    let source = rx("ord_without_eq_and_partial_ord_reports_e0606");
...
fn unknown_derive_trait_reports_e0608() {
    let source = rx("unknown_derive_trait_reports_e0608");
...
fn duplicate_derive_trait_reports_e0609() {
    let source = rx("duplicate_derive_trait_reports_e0609");

...
//!
//! Each test loads a `.rvn` fixture that triggers a specific
...
use riven_ide::code_actions::code_actions;
use riven_ide::diagnostics::collect_diagnostics;

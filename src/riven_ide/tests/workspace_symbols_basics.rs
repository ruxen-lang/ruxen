...
//!
//! Loads two `.rvn` files, builds two analysis results, and runs
...
use riven_ide::workspace_symbols::workspace_symbols;
...
fn fake_url(stem: &str) -> Url {
    Url::parse(&format!("file:///fixtures/{}.rvn", stem)).unwrap()
}

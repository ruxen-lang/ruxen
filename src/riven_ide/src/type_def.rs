...
fn return_ty_of(symbols: &SymbolTable, def_id: riven_core::hir::nodes::DefId) -> Option<Ty> {
...
fn find_type_def(
    symbols: &SymbolTable,
    named: &NamedType,
) -> Option<riven_core::hir::nodes::DefId> {
    let mut fallback: Option<riven_core::hir::nodes::DefId> = None;

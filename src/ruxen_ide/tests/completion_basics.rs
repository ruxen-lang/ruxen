...
//! lives in a `.rx` fixture file under
//! `src/ruxen_ide/tests/fixtures/completion/`. The cursor position is
...
use ruxen_ide::completion::completions;

/// Load a fixture by stem name (`<stem>.rx` under `fixtures/completion/`).

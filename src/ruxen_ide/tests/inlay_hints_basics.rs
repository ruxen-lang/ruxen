//! Integration tests for `ruxen_ide::inlay_hints` (spec §5.5).
//!
//! Each fixture lives in `tests/fixtures/inlay_hints/<stem>.rx` per
//! `feedback_no_inline_rx_in_pin_tests.md`. Hint labels are matched by

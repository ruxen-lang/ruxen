//! Wave-1 LSP formatting — fixture-druxen tests for
//! [`ruxen_ide::format::format_document`] and
//! [`ruxen_ide::format::format_range`].
//!
...
use ruxen_ide::format::{format_document, format_range};

/// Load a fixture by stem name (`<stem>.rx` under `fixtures/format/`).

...
//!
//! Run with: `cargo bench -p rivenc --bench parse_bench`.
//!
...
//!   * `fixture_508` — `tests/release-e2e/cases/508_command_status.rvn`
//!     (45 lines, ~3 defs, exercises Command builder + match arms +
//!     string interpolation — representative of typical user code)
//!   * `fixture_727_async` — `tests/release-e2e/cases/727_async_tcp_echo.rvn`
...
fn bench_parse(c: &mut Criterion) {
    ...
    let fixture_508 = read_fixture("508_command_status.rvn");
    let fixture_727 = read_fixture("727_async_tcp_echo.rvn");

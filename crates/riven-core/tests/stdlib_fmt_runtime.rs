...
fn formatter_write_str_then_buffer_round_trips() {
    let src = rvn("formatter_write_str_then_buffer_round_trips");
...
fn formatter_write_char_ascii_round_trips() {
    let src = rvn("formatter_write_char_ascii_round_trips");
...
fn interpolation_user_impl_display_money_round_trips() {
    let src = rvn("interpolation_user_impl_display_money_round_trips");
...
fn interpolation_width_right_align_pads_int() {
    let src = rvn("interpolation_width_right_align_pads_int");
...
fn interpolation_width_left_align_pads_int() {
    let src = rvn("interpolation_width_left_align_pads_int");
...
fn interpolation_width_center_align_pads_int() {
    let src = rvn("interpolation_width_center_align_pads_int");
...
fn interpolation_fill_char_left_align() {
    let src = rvn("interpolation_fill_char_left_align");
...
fn interpolation_float_precision() {
    let src = rvn("interpolation_float_precision");
...
fn interpolation_string_precision_truncates() {
    let src = rvn("interpolation_string_precision_truncates");
...
fn interpolation_width_and_precision_compose() {
    let src = rvn("interpolation_width_and_precision_compose");
...
fn formatter_len_after_write_str() {
    let src = rvn("formatter_len_after_write_str");
